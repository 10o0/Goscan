...
func SmbScan(info *common.HostsInfo) (tmperr error) {
	if common.IsBrute {
		return nil
	}
...
func SmblConn(info *common.HostsInfo, user string, pass string, signal chan struct{}) (flag bool, err error) {
	flag = false
...
func doWithTimeOut(info *common.HostsInfo, user string, pass string) (flag bool, err error) {
