...
func NetBIOS(info *common.HostsInfo) error {
...
func NetBIOS1(info *common.HostsInfo) (netbios NetBiosInfo, err error) {
...
func GetNbnsname(info *common.HostsInfo) (netbios NetBiosInfo, err error) {
