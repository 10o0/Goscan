...
import (
	...
	"github.com/10o0/Goscan/WebScan"
	"github.com/10o0/Goscan/WebScan/lib"
	"github.com/10o0/Goscan/common"
	"golang.org/x/text/encoding/simplifiedchinese"
)

func WebTitle(info *common.HostsInfo) error {
...
func GOWebTitle(info *common.HostsInfo) (err error, CheckData []WebScan.CheckDatas) {
	if info.Url == "" {
		switch info.Ports {
		case "80":
...
func geturl(info *common.HostsInfo, flag int, CheckData []WebScan.CheckDatas) (error, string, []WebScan.CheckDatas) {
	//flag 1 first try
	//flag 2 /favicon.ico
	//flag 3 302
	//flag 4 400 -> https
