...
func Scan(info common.HostsInfo) {
...
func AddScan(scantype string, info common.HostsInfo, ch *chan struct{}, wg *sync.WaitGroup) {
	*ch <- struct{}{}
	wg.Add(1)
	go func() {
		Mutex.Lock()
...
func ScanFunc(name *string, info *common.HostsInfo) {
