...
func SmbScan2(info *common.HostsInfo) (tmperr error) {
	if common.IsBrute {
		return nil
	}
	hasprint := false
...
func Smb2Con(info *common.HostsInfo, user string, pass string, hash []byte, hasprint bool) (flag bool, err error, flag2 bool) {
